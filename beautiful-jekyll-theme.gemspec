Gem::Specification.new do |spec|
  ...
  # Fixed: Executed shell command inside backticks (`...`) with a fallback for non-git environments
  files = `git ls-files -z`.split("\x0") rescue []
  spec.files         = files.select { |f| f.match(%r{^(assets|_layouts|_includes|LICENSE|README|feed|404|_data|tags|staticman)}i) }
